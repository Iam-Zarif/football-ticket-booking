...
-- ??? askedd for Retrieve all but in sample output only booking_id, user_id, match_id and payment_status. So I am assuming we need to select only those columns.
